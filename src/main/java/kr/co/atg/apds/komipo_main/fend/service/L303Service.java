...
public class L303Service {
  ...
  public List<GraphObject<Object>> getWaveform() {
     ...
     * -----|---------------------|------------------|------|--------|---------|----
     * ---------------|-------------------|-------------------|--------|--------|
     * |mptid |mptkey |measdt |twftype |lineresolution |deltatime |deltaorder |rpm
     * |units |unitstr |rawdata |overall |onexamp |onexphase |syncrev |syncspr |
     * |------|-------|--------------------|--------|---------------|---------------
     * ------|---------------------|------------------|------|--------|---------|---
     * ----------------|-------------------|-------------------|--------|--------|
     * |MOX |9 |2019-10-29 08:13:39 |3 |2048 |6.249999860301614E-4
     * |0.009360354532194156 |898.5940551757812 |3 |um |[unread] |11.909932694158938
     * |10.264335237591308 |140.02496993611945 |[null] |[null] |
     * |MOY |10 |2019-10-29 08:13:39 |3 |2048 |6.249999860301614E-4
     * |0.009360354532194156 |898.5940551757812 |3 |um |[unread] |13.199470410210854
     * |11.9099285275269 |-98.2630616942917 |[null] |[null] |
     * |------|-------|--------------------|--------|---------------|---------------
     * ------|---------------------|------------------|------|--------|---------|---
     * ----------------|-------------------|-------------------|--------|--------|
     */
